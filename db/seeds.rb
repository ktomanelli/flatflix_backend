...
res=RestClient.get "https://api.themoviedb.org/3/movie/popular?api_key=6ccb94cd2c533a5189819f3915add83d"
data = JSON.parse(res.body)
data["results"].each do |movie|
    newRes = RestClient.get "http://www.omdbapi.com/?apikey=43e36491&t=#{movie["title"]}"
